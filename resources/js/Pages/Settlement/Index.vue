                        ...
                        <div>
                            <div class="flow-root ">
                                <p class="float-left text-blue-600">
                                    <b>Settlement for Customers</b> <br> <br>
                                    ...
                                    <tbody>
                                        <tr v-for="customer in customers.data" class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                            ...
                                            <td class="px-6 py-4">
                                                ...
                                                <br><small>GST: {{ customer.gst }}</small>
                                            </td>
                                            <td class="px-6 py-4">
                                                <!-- <Link :href="route('sales.invoice.edit',customer.id)" class="font-medium text-blue-600 dark:text-blue-500 hover:underline px-2">Edit</Link> -->
                                                <Link :href="route('settlements.details.index',customer.id)" class="font-medium text-green-600 dark:text-blue-500 hover:underline">Details</Link>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
