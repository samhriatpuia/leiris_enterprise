...
const submit = () => {
    form.post(route("history.search"));
};
</script>
                        ...
                        <div>
                            <div class="flow-root ">
                                <p class="float-left text-blue-600">
                                    <b>History of Sales/Invoice List</b> <br> <br>
                                    ...
                                    <tbody>
                                        <tr v-for="sale in sales.data" class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                            ...
                                            <td class="px-6 py-4">
                                                ...
                                                <Link :href="route('history.invoice.index',sale.id)" class="font-medium text-green-600 dark:text-blue-500 hover:underline">Invoice</Link>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
